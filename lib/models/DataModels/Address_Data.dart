...
///
///
/// DESCRIPTION: AddressData is used to track users address info and provide them with a
///              unmodifiable list view. It also allows for the addition and removal of
///              addresses to the sharedPreferences.
///
...
class AddressData extends ChangeNotifier {
  ...
  /// Initializing the address list from stored shared preferences or for the first time with example values
